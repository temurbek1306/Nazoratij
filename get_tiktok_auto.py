...
CLIENT_KEY = "awfp56en3s617f3q"
CLIENT_SECRET = "iOBKSUoSA0M6qbgisJzPsunwyqiWQAEb"
...
class AuthHandler(BaseHTTPRequestHandler):
    def do_GET(self):
        ...
        if 'code' in params:
            ...
            self.wfile.write(b"<html><head><meta charset='utf-8'></head><body><h1>Ruxsat olindi! \u2705</h1><p>Bu oynani yopishingiz mumkin. Endi terminalga (yoki IDE'ga) qarang!</p></body></html>")
        else:
...
def main():
    print("="*50)
    print("\U0001f3b5 TikTok API OAuth2 Avtorizatsiya skripti")
    print("="*50)
